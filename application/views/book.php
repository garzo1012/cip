<?=$this->load->view('header')?>
		...
		<script src="<?=base_url()?>media/js/jquery.mousewheel.js"></script>
		<script src="<?=base_url()?>media/js/jquery.jscrollpane.min.js"></script>
		<script src="<?=base_url()?>media/js/jquerypp.custom.js"></script>
		<script src="<?=base_url()?>media/js/jquery.bookblock.js"></script>
		<script src="<?=base_url()?>media/js/page.js"></script>
		<script>
			$(function() {
